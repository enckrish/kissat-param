...
module RC_10_9(IN1, IN2, Out);
  ...
  FullAdder U1 (IN1[1], IN2[1], w20, Out[1], w22);
  FullAdder U2 (IN1[2], IN2[2], w22, Out[2], w24);
  FullAdder U3 (IN1[3], IN2[3], w24, Out[3], w26);
  FullAdder U4 (IN1[4], IN2[4], w26, Out[4], w28);
  FullAdder U5 (IN1[5], IN2[5], w28, Out[5], w30);
  FullAdder U6 (IN1[6], IN2[6], w30, Out[6], w32);
  FullAdder U7 (IN1[7], IN2[7], w32, Out[7], w34);
  FullAdder U8 (IN1[8], IN2[8], w34, Out[8], w36);
  HalfAdder U9 (IN1[9], w36, Out[9], Out[10]);
...
module Mult_7_7(IN1, IN2, Out);
  ...
  RC_10_9 S2 (R1[14:5], R2, aOut[15:5]);
  assign aOut[0] = R1[0];
  assign aOut[1] = R1[1];
  assign aOut[2] = R1[2];
  assign aOut[3] = R1[3];
